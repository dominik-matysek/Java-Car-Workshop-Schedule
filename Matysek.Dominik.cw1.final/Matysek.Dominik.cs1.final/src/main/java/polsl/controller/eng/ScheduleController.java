...
public class ScheduleController {
    ...
    /**
     * Represents ScheduleView object
     */
     ...
     * @param v ScheduleView object
     */
    
    public ScheduleController (Schedule s, ScheduleView v)
    {
        this.model = s;
        this.view = v;
    }
    ...
    /**
     * Method which updates the view of the Schedule 
     * after data input
     * @param s Schedule object
     */
    public void updateScheduleView(Schedule s)
    {
        this.view.showSchedule(this.model);
    }
    ...
    {
        if(act_name.matches("^[a-zA-Z ]+$") && mod.matches("^[a-zA-Z ]+$") && n.matches("[a-zA-Z ]+") && sn.matches("[a-zA-Z ]+") && adr.matches("^[a-zA-Z ]+$"))
        {
